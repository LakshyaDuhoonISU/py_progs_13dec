#design a library catalogue system using inheritance. take base class- library item, derived classes- book, dvd, journal. 
#each derived class should have unique attributes and methods and system should support checking in and checking out the items
class Library_item:
        _bookCount=0
        _dvdCount=0
        _journalCount=0
